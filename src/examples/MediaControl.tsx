import { useMediaControl } from "@hooks/ReactMediaControl";
...
export function MediaControl() {
	const {
		...
		changeSpeed,
		changePitch,
	} = useMediaControl<HTMLVideoElement>();
			...
			<div className="mb-2">
				<div className="flex flex-col gap-4 p-4 border border-zinc-700 rounded-md bg-zinc-900">
					...
					<div className="flex flex-col justify-center items-center gap-2">
						<div className="flex flex-row justify-start gap-2 text-xs uppercase tabular-nums">
							<div>Wait ({`${wait}`})</div>
					...
					<div className="flex flex-col text-blue-400 text-center underline">
